...
<xsl:stylesheet 
	...
	<xsl:template match="salesreqreport">
 					...
 					<fo:block-container width="50%" left="0%" margin-bottom="30px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px" font-weight="bold"><fo:block margin-top="7px">SRQ Number</fo:block></fo:table-cell>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px" font-weight="bold"><fo:block margin-top="7px"><xsl:value-of select="xdoreqnum"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									...
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xamount"/></fo:block></fo:table-cell>
									</fo:table-row>
									<xsl:if test="xstatus = 'Open'">
										<fo:table-row>
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header xsl:use-attribute-sets="table.font.size">
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right">
											<fo:block text-align="right">CF(Selling)</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left">
								...
								<fo:table-body>
									...
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" number-columns-spanned="7">
											<fo:block>Total</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
											<fo:block><xsl:value-of select="xamount"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
