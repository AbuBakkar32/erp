...
<xsl:stylesheet 
	...
	<xsl:template match="directsalesinvoicereport">
			...
			<fo:page-sequence master-reference="document">
				...
				<fo:static-content flow-name="header-first">
					...
					<fo:block-container width="100%">
						...
						<fo:block text-align="center" font-size="14px" font-weight="bold" margin-top="4px">
							<xsl:value-of select="reportName"/>
						</fo:block>


						<fo:block-container width="100%" height="180px" top="90px" right="0mm" position="absolute" >
							<fo:block>
								<fo:table table-layout="fixed" width="100%" border-collapse="collapse" border="solid 0.1mm black"  > 
									<fo:table-column column-width="70%" />
									<fo:table-column column-width="30%" />
									
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td" border="solid 0.1mm black"  font-size="10px">
												<fo:block>
													<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
														...
														<fo:table-body>
															<fo:table-row>
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px" font-weight="bold"><fo:block>TO:</fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row>
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Customer</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xcus"/>-<xsl:value-of select="xorg"/></fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row>
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Address</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xmadd"/></fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row>
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Phone</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xphone"/></fo:block></fo:table-cell>
															</fo:table-row>
														</fo:table-body>
													</fo:table>
												</fo:block>
											...
											<fo:table-cell xsl:use-attribute-sets="category.table.td">
												<fo:block>
													<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
														...
														<fo:table-body>
															<fo:table-row xsl:use-attribute-sets="client.table.td">
															...
															<fo:table-row xsl:use-attribute-sets="client.table.td">
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Bill No.</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xdornum"/></fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row xsl:use-attribute-sets="client.table.td">
																<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Payment</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xpaymenttype"/></fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row xsl:use-attribute-sets="client.table.td">
															...
															<!-- <fo:table-row xsl:use-attribute-sets="client.table.td">
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>Purpose</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xpurpose"/></fo:block></fo:table-cell>
															</fo:table-row>
															<fo:table-row xsl:use-attribute-sets="client.table.td">
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>Land ID</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
																<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xland"/></fo:block></fo:table-cell>
															</fo:table-row> -->
														</fo:table-body>
													</fo:table>
												</fo:block>
						...
						<fo:block-container position="absolute" width="40%"  top="550px">
							<fo:block>
								<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
									...
									<fo:table-body>
										<fo:table-row xsl:use-attribute-sets="client.table.td">
											<fo:table-cell height="80px" xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>Note : <xsl:value-of select="xnote"/></fo:block></fo:table-cell>
										</fo:table-row>
						...
						<fo:block-container width="25%" top="700px"  left="0%" padding-top="5px" position="absolute" border-top="1px dotted black" text-align="center">
							<fo:block>Prepared By</fo:block>
						</fo:block-container>
						<fo:block-container width="25%" top="700px" left="35%" padding-top="5px" position="absolute" border-top="1px dotted black" text-align="center">
							<fo:block>Authorized By</fo:block>
						</fo:block-container>
						<fo:block-container width="25%" top="700px" left="70%" padding-top="5px" position="absolute" border-top="1px dotted black" text-align="center">
				...
				<!-- BODY CONTENT -->
 				...
 				<xsl:if test="items/item">
					<fo:block-container width="100%" margin-top="120px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								<fo:table-column column-width="5%" />
								...
								<fo:table-body>
									...
									<fo:table-row>
										<fo:table-cell text-align="right" font-weight="bold" number-columns-spanned="4" >
											<fo:block></fo:block>
										</fo:table-cell>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
											<fo:block><xsl:value-of select="xtotamt"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
											<fo:table-cell text-align="right" font-weight="bold" number-columns-spanned="4" >
											...
											<xsl:if test="xvatait &gt; 0">
											<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" >
												 	<fo:block>(+)Ait Amount</fo:block>
											</fo:table-cell>
											
											<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
												<fo:block><xsl:value-of select="xaitamt"/></fo:block>
											</fo:table-cell>
											</xsl:if>
										</fo:table-row>
										<fo:table-row>
											...
											<xsl:if test="xvatamt &gt; 0">
											<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" >
												 	<fo:block>(+)Vat Amount</fo:block>
											</fo:table-cell>
											
											<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
												<fo:block><xsl:value-of select="xvatamt"/></fo:block>
											</fo:table-cell>
											</xsl:if>
										</fo:table-row>
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" >
											<fo:block>(-)Discount Amount</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
											<fo:block><xsl:value-of select="xdiscamt"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell text-align="right" font-weight="bold" number-columns-spanned="4" >
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" >
											<fo:block>Total Amount (BDT)</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold">
											<fo:block><xsl:value-of select="xgrandtot"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										
										<fo:table-cell text-align="left" font-weight="bold" number-columns-spanned="3" padding-top="10px" font-size="7pt">
											<fo:block>Total Amount (In Words) : <xsl:value-of select="spellword"/> <xsl:if test="xprimeword"> and </xsl:if><xsl:value-of select="xprimeword"/> Taka Only </fo:block>
										</fo:table-cell>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
