...
<xsl:stylesheet 
	...
	<xsl:template match="supplierpayment">
 				...
 				<fo:flow flow-name="xsl-region-body">
					<fo:block-container height="50%" position="absolute"  border-bottom="1px solid black">
						...
						<fo:block-container width="100%" position="absolute" height="100px">
							...
							<fo:block text-align="center" font-size="18px" font-weight="bold" margin-top="10px">
								<xsl:value-of select="reportName"/>
							</fo:block>
							<fo:block text-align="right" font-size="12px" font-weight="bold" font-style="italic" position="absolute">
							(Office Copy)
							</fo:block>
						</fo:block-container>
	
						<fo:block-container width="100%" height="180px" top="100px" right="0mm" position="absolute">
							<fo:block>
								<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
									...
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Receipt Number</fo:block></fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xdate"/></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
										...
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>The Amount of TAKA (In Words)</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
						...
						<fo:block-container width="35%" top="340px" left="0%" padding-top="5px" position="absolute" border-top="1px dotted black">
							<fo:block>Paid By</fo:block>
						</fo:block-container>
						<fo:block-container width="35%" top="340px" left="50%" padding-top="5px" position="absolute" border-top="1px dotted black">
							<fo:block>Received By</fo:block>
						</fo:block-container>

						<fo:block-container width="50%" top="220px" left="50%" position="absolute">
							<fo:block>
								<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
									...
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block font-size="12px" font-weight="bold">Paid To</fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Supplier ID</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xcus"/></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Supplier Name</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xorg"/> <xsl:value-of select="bankname"/></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Address</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xmadd"/> <xsl:value-of select="bankname"/></fo:block></fo:table-cell>
										</fo:table-row>
									</fo:table-body>
								</fo:table>
							</fo:block>
