			...
			<fo:page-sequence master-reference="document">
				...
				<!-- BODY CONTENT -->
 				<fo:flow flow-name="xsl-region-body">
					<fo:block-container width="50%" left="0%" top="10px" position="absolute">
						<fo:block>
					...
					<fo:block-container width="100%" right="0mm" margin-top="150px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
					...
					<fo:block-container width="100%" right="0mm" margin-top="20px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" number-columns-spanned="4"><fo:block text-align="center">Survey Details</fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>SL</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>Surveyor</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>Date</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>Details</fo:block></fo:table-cell>
									</fo:table-row>
								</fo:table-header>
