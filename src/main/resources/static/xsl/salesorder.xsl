...
<xsl:stylesheet 
	...
	<xsl:template match="salesorderreport">
 					...
 					<fo:block-container width="50%" left="0%" margin-bottom="30px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px" font-weight="bold"><fo:block margin-top="7px">SO Number</fo:block></fo:table-cell>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px" font-weight="bold"><fo:block margin-top="7px"><xsl:value-of select="xordernum"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block>Date</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block>:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block><xsl:value-of select="fromDate"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="9px"><fo:block>Customer</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block>:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block><xsl:value-of select="xcus"/>-<xsl:value-of select="xorg"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="9px"><fo:block>Project/Business</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block>:</fo:block></fo:table-cell>
										<xsl:if test="xhwh">
											<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block><xsl:value-of select="xhwh"/>-<xsl:value-of select="projectName"/></fo:block></fo:table-cell>
										</xsl:if>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="9px"><fo:block>Site/Store</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block>:</fo:block></fo:table-cell>
										<xsl:if test="xhwh">
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="9px"><fo:block><xsl:value-of select="xwh"/>-<xsl:value-of select="storeName"/></fo:block></fo:table-cell>
										</xsl:if>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
					...
					<fo:block-container width="50%" left="50%" margin-top="10px" margin-bottom="30px" position="absolute" >
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block margin-top="7px">Reference</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block margin-top="7px">:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block margin-top="7px"><xsl:value-of select="xref"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										...
										<fo:table-row>
											...
											<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xstatusord"/></fo:block></fo:table-cell>
										</fo:table-row>
									<fo:table-row>
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header xsl:use-attribute-sets="table.font.size">
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left">
											<fo:block text-align="left">Row</fo:block>
										</fo:table-cell> 
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left">
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right">
											<fo:block>Completed Invoice Qty.</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right">
								...
								<fo:table-body>
									...
									<xsl:if test="not(items/item)">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="10" xsl:use-attribute-sets="client.table.td">
	...
	<xsl:template match="items/item">
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="left">
				<fo:block>
					<xsl:value-of select="xlong"/>
				</fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block>
					<xsl:value-of select="xqtydel"/>
				</fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block>
