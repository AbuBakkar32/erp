...
<xsl:stylesheet 
	...
	<xsl:template match="salesreturnreport">
			...
			<fo:page-sequence master-reference="document">
				...
				<!-- BODY CONTENT -->
 				<fo:flow flow-name="xsl-region-body">
 					<fo:block-container width="50%" left="0%" margin-bottom="30px">
 						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px" font-weight="bold"><fo:block margin-top="7px">Return Number</fo:block></fo:table-cell>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px" font-weight="bold"><fo:block margin-top="7px"><xsl:value-of select="xcrnnum"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
									...
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
										<xsl:if test="xhwh">
										 	<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xhwh"/>-<xsl:value-of select="projectName"/></fo:block></fo:table-cell>
										</xsl:if>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Site/Store</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
										<xsl:if test="xwh">
									...
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Payment Type</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
 					...
 					<fo:block-container width="50%" left="50%" margin-top="10px" margin-bottom="30px" position="absolute" >
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								<fo:table-column column-width="30%" />
								<fo:table-column column-width="3%" />
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block margin-top="7px">Voucher No</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block margin-top="7px">:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block margin-top="7px"><xsl:value-of select="xvoucher"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Status</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xstatuscrn"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
									...
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block><xsl:value-of select="xdiscamt"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
					...
					<fo:block-container width="100%">
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									...
									<xsl:if test="not(items/item)">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="11" xsl:use-attribute-sets="client.table.td">
												<fo:block>No Items found</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</xsl:if>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" number-columns-spanned="8">
						...
						<fo:block font-size="8px" padding-top="10px" padding-bottom="5px" text-align="left">
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell><fo:block font-weight="bold">Total Amount in Words</fo:block></fo:table-cell>
