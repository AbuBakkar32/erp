...
<xsl:stylesheet 
	...
	<xsl:template match="purchasereqreport">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="A4-last" page-height="29.02cm" page-width="21cm" margin-top="6mm" margin-bottom="6mm" margin-left="6mm" margin-right="6mm">
					<fo:region-body margin-top="0mm" margin-left="0mm" margin-right="0mm" margin-bottom="5mm" />
					<fo:region-before region-name="footer-last" extent="25mm"/>
					<fo:region-after region-name="footer-pagenumber" extent="4.5mm"/>
				</fo:simple-page-master>
			...
			<fo:page-sequence master-reference="document">
				...
				<!-- BODY CONTENT -->
 				<fo:flow flow-name="xsl-region-body">
						...
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									...
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="category.table.td"  font-size="10px"><fo:block>Requisition By</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block>:</fo:block></fo:table-cell>
					...
					<fo:block-container width="100%" margin-bottom="10px">
							<fo:block>
						...
						<fo:block-container width="100%" margin-bottom="30px">
							<fo:block font-size="8px" padding-top="10px" padding-bottom="30px" text-align="left">
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
							...
							<fo:table-column column-width="78%" />
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell><fo:block font-weight="bold">Total Net Amount in Words</fo:block></fo:table-cell>
				...
				<fo:block-container width="100%" left="0%" margin-bottom="10px">
					<fo:block>
						<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
						...
						<fo:table-column column-width="25%"/>
							<fo:table-body>
								<fo:table-row>
								<fo:table-cell xsl:use-attribute-sets="category.table.td" border-top="1px dotted black" font-size="10px"><fo:block text-align="center">Prepared By</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="category.table.td" font-size="10px"><fo:block> </fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="category.table.td" border-top="1px dotted black" font-size="10px"><fo:block text-align="center">Approved By</fo:block></fo:table-cell>
								</fo:table-row>
							</fo:table-body>
						</fo:table>
					</fo:block>
