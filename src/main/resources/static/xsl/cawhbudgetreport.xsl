...
<xsl:stylesheet 
	...
	<xsl:template match="cawhbudgetreport">
			...
			<fo:page-sequence master-reference="document">
				...
				<!-- BODY CONTENT -->
 				<fo:flow flow-name="xsl-region-body">
					<fo:block-container width="50%" left="0%" margin-top="10px" margin-bottom="10px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.td.noborder"><fo:block>Budget Code</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td.noborder"><fo:block>:</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td.noborder"><fo:block><xsl:value-of select="xbudget"/></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
						...
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									...
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.td.noborder"><fo:block>Prepared Date</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td.noborder"><fo:block>:</fo:block></fo:table-cell>
					...
					<xsl:if test="budgetdetails/budgetdetail">
					<fo:block-container width="100%" right="0mm" margin-top="40px">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" number-columns-spanned="4"><fo:block text-align="center">Budget Details</fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>Budget Amount</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th"><fo:block>Tolerance(%)</fo:block></fo:table-cell>
									</fo:table-row>
								</fo:table-header>

								<fo:table-body>
									<xsl:if test="not(budgetdetails/budgetdetail)">
										<fo:table-row>
									...
									<xsl:if test="budgetdetails/budgetdetail">
										<xsl:apply-templates select="budgetdetails/budgetdetail"/>
									</xsl:if>
									<fo:table-row>
	...
	<xsl:template match="budgetdetails/budgetdetail">
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td">
				<fo:block><xsl:value-of select="xtolerance"/></fo:block>
			</fo:table-cell>
		</fo:table-row>
	</xsl:template>
