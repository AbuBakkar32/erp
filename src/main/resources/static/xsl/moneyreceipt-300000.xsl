							...
							<fo:block>
								<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
									...
									<fo:table-body>
										...
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Purpose</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xpurpose"/></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>Land ID</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block>:</fo:block></fo:table-cell>
											<fo:table-cell xsl:use-attribute-sets="category.table.td"><fo:block><xsl:value-of select="xland"/></fo:block></fo:table-cell>
										</fo:table-row>
									</fo:table-body>
								</fo:table>
							</fo:block>
