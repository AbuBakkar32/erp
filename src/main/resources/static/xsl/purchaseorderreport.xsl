...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
<!--!                                                              !-->
<!--!    File Name    : purchaseorderreport.xsl                    !-->
<!--!    Description  : Purchase Order Report (Single)             !-->
...
<xsl:stylesheet 
	...
	<xsl:template match="purchasereport">
					...
					<fo:block-container width="100%" margin-top="0px" right="0mm">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<xsl:apply-templates select="purchaseorders/purchaseorder"/>
								</fo:table-body>
							</fo:table>
						</fo:block>
					</fo:block-container>
	...
	<xsl:template match="purchaseorders/purchaseorder">
		<fo:table-row>
			<fo:table-cell xsl:use-attribute-sets="category.table.td" margin-top="10px">
					...
					<fo:block font-size="8px" padding-top="30px" padding-bottom="5px" text-align="left">
						<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell><fo:block font-weight="bold">PO Number</fo:block></fo:table-cell>
								...
								<fo:table-row>
									<fo:table-cell><fo:block>Order By</fo:block></fo:table-cell>
									<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
			...
			<fo:block-container width="50%" left="50%" top="10px" position="absolute">	
				<fo:block font-size="8px" padding-top="30px" padding-bottom="5px" text-align="left">
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell><fo:block>Site/Store</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block><xsl:value-of select="xwh"/>-<xsl:value-of select="storeName"/></fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell><fo:block>Reference</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block><xsl:value-of select="xref"/></fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block><xsl:value-of select="xstatuspor"/></fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row>
				...
				<fo:block>
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" font-weight="bold" number-columns-spanned="4">
