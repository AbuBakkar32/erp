...
@Data
@Entity
@Table(name = "pdgradedt")
@IdClass(PdgradedtPK.class)
@EqualsAndHashCode(of = { "zid", "xstaff","xrow" }, callSuper = false)
public class Pdgradedt extends AbstractModel<String>{

	
	private static final long serialVersionUID = -8003167594970511046L;
