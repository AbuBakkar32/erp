 ...
 * @since Dec 27, 2020
 */
@Service("RM0306Service")
public class RM0306ServiceImpl extends AbstractReportService {
	...
	private List<FormFieldBuilder> generateFields() {
		...
		// xpornum
		fieldsList.add(FormFieldBuilder.generateInputField(7, "Purchase No", "", false));
