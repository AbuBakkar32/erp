 ...
 * @since Dec 27, 2020
 */
@Service("RM0605Service")
public class RM0605ServiceImpl extends AbstractReportService {
	...
	private List<FormFieldBuilder> generateFields() {
		...
		statusList.stream().forEach(x -> options.add(new DropdownOption(x.getXcode(), x.getXcode() + "-" + x.getXlong())));
